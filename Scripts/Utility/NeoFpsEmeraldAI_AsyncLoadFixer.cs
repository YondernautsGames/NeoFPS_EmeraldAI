...
namespace NeoFPS.EmeraldAI
{
    public class NeoFpsEmeraldAI_AsyncLoadFixer : MonoBehaviour
    {
        public IEnumerator Start()
        {
            ...
            // This means that any new global objects that Emerald AI creates in Awake() are placed in the loading screen scene, not the main game / AI scene
            ...
            if (EmeraldSystem.ObjectPool == null)
            {
                ...
                EmeraldSystem.ObjectPool.name = "Emerald Object Pool";
            }
